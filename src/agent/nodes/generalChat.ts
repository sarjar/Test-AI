...
const financeKeywords = [
  "etf", "dividend", "stock", "investment", "portfolio", "yield", "finance", "financial", 
  "market", "strategy", "advisor", "consultant", "trading", "broker", "fund", "equity",
  "bond", "asset", "return", "profit", "loss", "risk", "diversification", "allocation",
  "retirement", "401k", "ira", "roth", "pension", "savings", "wealth", "money",
  "capital", "income", "expense", "budget", "tax", "inflation", "recession",
  "bull market", "bear market", "volatility", "liquidity", "sector", "industry"
];
...
const generalChatNode = async ({ state }: { state: WorkflowState }) => {
  try {
    if (!state.userInput) {
      return {
        ...state,
